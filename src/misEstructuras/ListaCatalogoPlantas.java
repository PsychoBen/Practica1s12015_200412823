...
public class ListaCatalogoPlantas {
     ...
     */
    public void insertarPlanta(NodoPlanta nuevo)
    {
        NodoPlanta ultimo;
        NodoPlanta aux; 
        if (inicio == null){
     ...
     */
    public void eliminarPlanta(NodoPlanta nodoDelete)
    {
        NodoPlanta anterior, posterior;
        if (nodoDelete != null)
        {
     ...
     */
    public NodoPlanta buscarPlantasPorNombre(String nombre){

        NodoPlanta encontrado = null; 
        NodoPlanta aux;
     ...
     * @return encontrado el nodo de usuario encontrado que corresponde con el buscado
     */
    public NodoPlanta buscarPlantaPorImagen(String nombre){
...
//        System.out.println("node"+(k + 1)+" -> node"+k+";");
    ...
    public NodoPlanta getInicio() {
        return inicio;
    }

    public void setInicio(NodoPlanta inicio) {
        this.inicio = inicio;
    }
    ...
    public NodoPlanta getFin() {
        return fin;
    }

    public void setFin(NodoPlanta fin) {
        this.fin = fin;
    }    
